...
String get matsuAddress => 'Adress: No. 19, Songgao Road 6F, A4, Xintiandi, Shin Kong Mitsukoshi Xinyi, Xinyi District, Taipei 110 Taiwan';
  ...
  String get malaysia =>'Malaysia';
  @override
  String get MountKinabaluScreen => 'Mount Kinabalu';
  @override
  ...
  @override
  String get MountKinabaluAddress => 'Address: Mount Kinabalu, Malaysia';
  @override
  String get MantananiScreen => 'Mantanani';
  @override
  String get MantananiDescription => 'Sabah’s Mantanani Islands located near Kota Belud are some of the most famous tourist places in Malaysia that offer Borneo’s finest diving sites just an hour from Kota Kinabalu. It’s among the most famous places in Malaysia owing to its diving locales and a favorite of all snorkelers and divers who flock to this island on day trips from the capital city. Swarming in large numbers, divers come in from all parts of the world at these islands to wander in its clear waters and meet seahorses and stingrays. Scuba-certified divers can choose from more than 20 locations here for these water sports in Malaysia.';
  @override
  String get MantananiAddress => 'Address: Mantanani, Malaysia';
  @override
  String get LangkawiScreen => 'Langkawi Island';
  @override
  String get LangkawiDescription => 'A beautiful archipelago, Langkawi Island is a destination known for its vast expanse of sandy beaches and azure blue water which enthrall the tourists. The Langkawi Geopark is a UNESCO heritage site that attracts a large number of visitors and is, undoubtedly, the top among the must-visit places in Malaysia. It is a perfect manifestation of the geological heritage in the area. It is one of the best places to visit in Malaysia with family.';
  @override
  String get LangkawiAddress => 'Langkawi Island, Malaysia';
  @override
  String get MovHotels => 'Mov Hotel';

  @override
  String get MovHotelsDescription => 'Nestled in the heart of Bukit Bintang, this hotel offers easy access to various eateries, shopping malls, and exciting food streets. Boasting modern and aesthetically pleasing rooms, a stunning rooftop pool with city views, and friendly staff, it is the perfect choice for a comfortable and convenient stay.';
  @override
  String get SunwayPutraHotel => 'Sunway Putra Hotel';

  @override
  String get SunwayPutraHotelDescription => 'Charming hotel connected to a shopping mall, offering convenient access to various eateries and public transportation. Boasts spacious, clean rooms with free upgrades available, impressive views, and cozy on-site coffee house. Excellent location near PWTC Station for easy city exploration.';
  @override
  String get PacificSuteraHotel => 'Pacific Sutera Hotel';

  @override
  String get PacificSuteraHotelDescription => 'Luxurious resort with beautiful sea and garden views. Clean, classy rooms with local touch. Features private beach, golf course, pools, and children playground. A top choice for dining with multiple restaurants, including Al Fresco, Silk Garden, and Cafe Boleh. Memorable stay, helpful staff.';
  @override
  String get EnakKL => 'Enak KL';

  @override
  String get EnakKLDescription => 'An upscale Malay eatery, Enak is housed in the very posh Starhill Gallery in Kuala Lumpur. Being one of the finest places to dine in the capital city, one can try the most delicious Malay dishes, many of which are based on recipes that have been handed down through the generations in the family of Sherena Razaly, the restaurant’s owner. While the flavors are all traditional in signature dishes like Ayam Goreng Lengkuas which is the fried chicken with blue ginger, Enak is undoubtedly the best Malaysian restaurant in Kuala Lumpur and a must-visit when you are in the city.';
  @override
  String get RestoranSamy => 'Restoran Samy';

  @override
  String get RestoranSamyDescription => 'In search of the top Indian restaurant in Malaysia? Visit the Restoran Samy in Ipoh if you want to try some authentic Indian dishes. The restaurant is equivalent to Devi’s Corner in Kuala Lumpur and having thrived for more than 20 years, Restoran Samy offers superb banana leaf rice, and amazing vegetarian and non-vegetarian dishes.';
  @override
  String get LeQueRestaurant => 'Le Que Restaurant';
