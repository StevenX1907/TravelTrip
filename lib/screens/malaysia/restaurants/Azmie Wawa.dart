...
class Azmie extends StatefulWidget {
  const Azmie({Key? key}) : super(key: key);

  @override
  State<Azmie> createState() => _Azmie();
}

class _Azmie extends State<Azmie> {
          ...
          child: Padding(
            ...
            child: Column(
              ...
              children: <Widget>[
                Container(
                  ...
                  decoration: BoxDecoration(
                    ...
                    image: DecorationImage(
                      image: AssetImage(
                          'assets/malaysia/restaurants/Azmie Wawa1.jpg'),
                      fit: BoxFit.cover,
                    ),
                  ),
                ...
                Text(
                  AppLocalizations.of(context).Azmie,
                  style: TextStyle(
                    fontSize: 24,
                ...
                Text(
                  AppLocalizations.of(context).AzmieDescription,
                      ...
                      child: GestureDetector(
                        onTap: () async {
                          await showDialog(
                            ...
                            builder: (_) => imageDialog(
                              'Azmie Wawa',
                              'assets/malaysia/restaurants/Azmie Wawa2.jpg',
                              context,
                            ),
                          );
                        },
                        child: Container(
                          ...
                          decoration: BoxDecoration(
                            ...
                            borderRadius: BorderRadius.circular(12),
                            image: DecorationImage(
                              image: AssetImage('assets/malaysia/restaurants/Azmie Wawa2.jpg'),
                              fit: BoxFit.cover,
                            ),
                          ),
                        ),
                      ...
                      child: GestureDetector(
                        onTap: () async {
                          await showDialog(
                            ...
                            builder: (_) => imageDialog(
                              'Azmie Wawa',
                              'assets/malaysia/restaurants/Azmie Wawa3.jpg',
                              context,
                            ),
                          );
                        },
                      ...
                      child: GestureDetector(
                        onTap: () async {
                          await showDialog(
                            ...
                            builder: (_) => imageDialog(
                              'Azmie Wawa',
                              'assets/malaysia/restaurants/Azmie Wawa4.jpg',
                              context,
                            ),
                          );
                        },
