...
class EnakKL extends StatefulWidget {
  const EnakKL({super.key});

  @override
  State<EnakKL> createState() => _EnakKLState();
}

class _EnakKLState extends State<EnakKL> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        title: Text(AppLocalizations.of(context).EnakKL),
          ...
          child: Padding(
            ...
            child: Column(
              ...
              children: <Widget>[
                ...
                Text(
                  AppLocalizations.of(context).EnakKL,
                  style: TextStyle(
                    fontSize: 24,
                ...
                Text(
                  AppLocalizations.of(context).EnakKLDescription,
