...
class RestoranSamy extends StatefulWidget {
  const RestoranSamy({super.key});

  @override
  State<RestoranSamy> createState() => _RestoranSamyState();
}

class _RestoranSamyState extends State<RestoranSamy> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        title: Text(AppLocalizations.of(context).RestoranSamy),
          ...
          child: Padding(
            ...
            child: Column(
              ...
              children: <Widget>[
                ...
                Text(
                  AppLocalizations.of(context).RestoranSamy,
                  style: TextStyle(
                    fontSize: 24,
                ...
                Text(
                  AppLocalizations.of(context).RestoranSamyDescription,
