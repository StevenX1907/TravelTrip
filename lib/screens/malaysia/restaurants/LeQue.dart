...
class LeQueRestaurant extends StatefulWidget {
  const LeQueRestaurant({super.key});

  @override
  State<LeQueRestaurant> createState() => _LeQueRestaurantState();
}

class _LeQueRestaurantState extends State<LeQueRestaurant> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        title: Text(AppLocalizations.of(context).LeQueRestaurant),
          ...
          child: Padding(
            ...
            child: Column(
              ...
              children: <Widget>[
                ...
                Text(
                  AppLocalizations.of(context).LeQueRestaurant,
                  style: TextStyle(
                    fontSize: 24,
                ...
                Text(
                  AppLocalizations.of(context).LeQueRestaurantDescription,
