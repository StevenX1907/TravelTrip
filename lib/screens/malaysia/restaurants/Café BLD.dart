...
class Bld extends StatefulWidget {
  const Bld({Key? key}) : super(key: key);

  @override
  State<Bld> createState() => _Bld();
}

class _Bld extends State<Bld> {
          ...
          child: Padding(
            ...
            child: Column(
              ...
              children: <Widget>[
                Container(
                  ...
                  decoration: BoxDecoration(
                    ...
                    image: DecorationImage(
                      image: AssetImage(
                          'assets/malaysia/restaurants/Café BLD1.jpg'),
                      fit: BoxFit.cover,
                    ),
                  ),
                ...
                Text(
                  AppLocalizations.of(context).CafeBLD,
                  style: TextStyle(
                    fontSize: 24,
                ...
                Text(
                  AppLocalizations.of(context).CafeBLDDescription,
                      ...
                      child: GestureDetector(
                        onTap: () async {
                          await showDialog(
                            ...
                            builder: (_) => imageDialog(
                              'Café BLD',
                              'assets/malaysia/restaurants/Café BLD2.jpg',
                              context,
                            ),
                          );
                        },
                        child: Container(
                          ...
                          decoration: BoxDecoration(
                            ...
                            borderRadius: BorderRadius.circular(12),
                            image: DecorationImage(
                              image: AssetImage('assets/malaysia/restaurants/Café BLD2.jpg'),
                              fit: BoxFit.cover,
                            ),
                          ),
                        ),
                      ...
                      child: GestureDetector(
                        onTap: () async {
                          await showDialog(
                            ...
                            builder: (_) => imageDialog(
                              'Café BLD',
                              'assets/malaysia/restaurants/Café BLD3.jpg',
                              context,
                            ),
                          );
                        },
                      ...
                      child: GestureDetector(
                        onTap: () async {
                          await showDialog(
                            ...
                            builder: (_) => imageDialog(
                              'Café BLD',
                              'assets/malaysia/restaurants/Café BLD4.jpg',
                              context,
                            ),
                          );
                        },
