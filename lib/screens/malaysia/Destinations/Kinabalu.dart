...
class kinabaluScreen extends StatefulWidget {
  const kinabaluScreen({super.key});

  @override
  State<kinabaluScreen> createState() => _kinabaluScreenState();
}

class _kinabaluScreenState extends State<kinabaluScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        title: Text(AppLocalizations.of(context).MountKinabaluScreen),
          ...
          child: Padding(
            ...
            child: Column(
              ...
              children: <Widget>[
                ...
                Text(
                  AppLocalizations.of(context).MountKinabaluScreen,
                  style: TextStyle(
                    fontSize: 24,
                ...
                Text(
                  AppLocalizations.of(context).MountKinabaluDescription,
                ...
                ListTile(
                  ...
                  title: Text(AppLocalizations.of(context).MountKinabaluAddress),
                ),
                // Comment Section
                const SizedBox(height: 16),
                Text(
