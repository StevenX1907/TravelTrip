...
class MantananiScreen extends StatefulWidget {
  const MantananiScreen({super.key});

  @override
  State<MantananiScreen> createState() => _MantananiScreenState();
}

class _MantananiScreenState extends State<MantananiScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        title: Text(AppLocalizations.of(context).MantananiScreen),
          ...
          child: Padding(
            ...
            child: Column(
              ...
              children: <Widget>[
                ...
                Text(
                  AppLocalizations.of(context).MantananiScreen,
                  style: TextStyle(
                    fontSize: 24,
                ...
                Text(
                  AppLocalizations.of(context).MantananiDescription,
                ...
                ListTile(
                  ...
                  title: Text(AppLocalizations.of(context).MantananiAddress),
                ),
                // Comment Section
                const SizedBox(height: 16),
                Text(
