...
class BirdPark extends StatefulWidget {
  const BirdPark({Key? key}) : super(key: key);

  @override
  State<BirdPark> createState() => _BirdPark();
}

class _BirdPark extends State<BirdPark> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        title: Text('Kuala Lumpur Bird Park'),
          ...
          child: Padding(
            ...
            child: Column(
              ...
              children: <Widget>[
                Container(
                  ...
                  decoration: BoxDecoration(
                    ...
                    image: DecorationImage(
                      image: AssetImage(
                          'assets/malaysia/destinations/Kuala Lumpur Bird Park1.jpg'),
                      fit: BoxFit.cover,
                    ),
                  ),
                ...
                Text(
                  AppLocalizations.of(context).Birdpark,
                  style: TextStyle(
                    fontSize: 24,
                ...
                Text(
                  AppLocalizations.of(context).BirdparkDescription,
                      ...
                      child: GestureDetector(
                        onTap: () async {
                          await showDialog(
                            ...
                            builder: (_) => imageDialog(
                              ...
                              'assets/malaysia/destinations/Kuala Lumpur Bird Park2.jpg',
                              context,
                            ),
                          );
                        },
                        child: Container(
                          ...
                          decoration: BoxDecoration(
                            ...
                            borderRadius: BorderRadius.circular(12),
                            image: DecorationImage(
                              image: AssetImage('assets/malaysia/destinations/Kuala Lumpur Bird Park2.jpg'),
                              fit: BoxFit.cover,
                            ),
                          ),
                        ),
                      ...
                      child: GestureDetector(
                        onTap: () async {
                          await showDialog(
                            ...
                            builder: (_) => imageDialog(
                              'Kuala Lumpur Bird Park',
                              'assets/malaysia/destinations/Kuala Lumpur Bird Park3.jpg',
                              context,
                            ),
                          );
                        },
                      ...
                      child: GestureDetector(
                        onTap: () async {
                          await showDialog(
                            ...
                            builder: (_) => imageDialog(
                              'Kuala Lumpur Bird Park',
                              'assets/malaysia/destinations/Kuala Lumpur Bird Park4.jpg',
                              context,
                            ),
                          );
                        },
