...
class langkawiScreen extends StatefulWidget {
  const langkawiScreen({super.key});

  @override
  State<langkawiScreen> createState() => _langkawiScreenState();
}

class _langkawiScreenState extends State<langkawiScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        title: Text(AppLocalizations.of(context).LangkawiScreen),
          ...
          child: Padding(
            ...
            child: Column(
              ...
              children: <Widget>[
                ...
                Text(
                  AppLocalizations.of(context).LangkawiScreen,
                  style: TextStyle(
                    fontSize: 24,
                ...
                Text(
                  AppLocalizations.of(context).LangkawiDescription,
                ...
                ListTile(
                  ...
                  title: Text(AppLocalizations.of(context).LangkawiAddress),
                ),
                // Comment Section
                const SizedBox(height: 16),
                Text(
