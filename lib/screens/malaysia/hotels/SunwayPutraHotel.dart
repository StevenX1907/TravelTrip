...
class SunwayPutraHotel extends StatefulWidget {
  const SunwayPutraHotel({super.key});

  @override
  State<SunwayPutraHotel> createState() => _SunwayPutraHotelState();
}

class _SunwayPutraHotelState extends State<SunwayPutraHotel> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        title: Text(AppLocalizations.of(context).SunwayPutraHotel),
          ...
          child: Padding(
            ...
            child: Column(
              ...
              children: <Widget>[
                ...
                Text(
                  AppLocalizations.of(context).SunwayPutraHotel,
                  style: TextStyle(
                    fontSize: 24,
                ...
                Text(
                  AppLocalizations.of(context).SunwayPutraHotelDescription,
