...
class Trove extends StatefulWidget {
  const Trove({Key? key}) : super(key: key);

  @override
  State<Trove> createState() => _Trove();
}

class _Trove extends State<Trove> {
          ...
          child: Padding(
            ...
            child: Column(
              ...
              children: <Widget>[
                Container(
                  ...
                  decoration: BoxDecoration(
                    ...
                    image: DecorationImage(
                      image: AssetImage(
                          'assets/malaysia/hotels/TROVE Johor Bahru1.jpg'),
                      fit: BoxFit.cover,
                    ),
                  ),
                ...
                Text(
                  AppLocalizations.of(context).Trove,
                  style: TextStyle(
                    fontSize: 24,
                ...
                Text(
                  AppLocalizations.of(context).TroveDescription,
                      ...
                      child: GestureDetector(
                        onTap: () async {
                          await showDialog(
                            ...
                            builder: (_) => imageDialog(
                              'TROVE Johor Bahru',
                              'assets/malaysia/hotels/TROVE Johor Bahru2.jpg',
                              context,
                            ),
                          );
                        },
                        child: Container(
                          ...
                          decoration: BoxDecoration(
                            ...
                            borderRadius: BorderRadius.circular(12),
                            image: DecorationImage(
                              image: AssetImage('assets/malaysia/hotels/TROVE Johor Bahru2.jpg'),
                              fit: BoxFit.cover,
                            ),
                          ),
                        ),
                      ...
                      child: GestureDetector(
                        onTap: () async {
                          await showDialog(
                            ...
                            builder: (_) => imageDialog(
                              'TROVE Johor Bahru',
                              'assets/malaysia/hotels/TROVE Johor Bahru3.jpg',
                              context,
                            ),
                          );
                        },
                      ...
                      child: GestureDetector(
                        onTap: () async {
                          await showDialog(
                            ...
                            builder: (_) => imageDialog(
                              'TROVE Johor Bahru',
                              'assets/malaysia/hotels/TROVE Johor Bahru4.jpg',
                              context,
                            ),
                          );
                        },
