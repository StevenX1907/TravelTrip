...
class MovHotels extends StatefulWidget {
  const MovHotels({super.key});

  @override
  State<MovHotels> createState() => _MovHotelsState();
}

class _MovHotelsState extends State<MovHotels> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        title: Text(AppLocalizations.of(context).MovHotels),
          ...
          child: Padding(
            ...
            child: Column(
              ...
              children: <Widget>[
                ...
                Text(
                  AppLocalizations.of(context).MovHotels,
                  style: TextStyle(
                    fontSize: 24,
                ...
                Text(
                  AppLocalizations.of(context).MovHotelsDescription,
