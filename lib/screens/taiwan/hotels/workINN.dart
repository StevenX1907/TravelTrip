...
class WorkINN extends StatefulWidget {
  const WorkINN({super.key});

  @override
  State<WorkINN> createState() => _WorkINNState();
}

class _WorkINNState extends State<WorkINN> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        title: Text(AppLocalizations.of(context).workinn),
          ...
          child: Padding(
            ...
            child: Column(
              ...
              children: <Widget>[
                Container(
                  ...
                  decoration: BoxDecoration(
                    ...
                    image: DecorationImage(
                      image: AssetImage(
                          'assets/taiwan/hotels/workinn5.jpg'),
                      fit: BoxFit.cover,
                    ),
                  ),
                ...
                Text(
                  AppLocalizations.of(context).workinn,
                  style: TextStyle(
                    fontSize: 24,
                ...
                Text(
                  AppLocalizations.of(context).workinnDescription,
                      ...
                      child: GestureDetector(
                        ...
                        child: Container(
                          ...
                          decoration: BoxDecoration(
                            ...
                            image: DecorationImage(
                              image: AssetImage(
                                  'assets/taiwan/hotels/workinn1.jpg'),
                              fit: BoxFit.cover,
                            ),
                          ),
                          // child: YourImageWidget(), // Uncomment and replace with your image widget
                      ...
                      child: GestureDetector(
                        ...
                        child: Container(
                          ...
                          decoration: BoxDecoration(
                            ...
                            image: DecorationImage(
                              image: AssetImage(
                                  'assets/taiwan/hotels/workinn2.jpg'),
                              fit: BoxFit.cover,
                            ),
                          ),
                          // child: YourImageWidget(), // Uncomment and replace with your image widget
                      ...
                      child: GestureDetector(
                        ...
                        child: Container(
                          ...
                          decoration: BoxDecoration(
                            ...
                            image: DecorationImage(
                              image: AssetImage(
                                  'assets/taiwan/hotels/workinn3.jpg'),
                              fit: BoxFit.cover,
                            ),
                          ),
                          // child: YourImageWidget(), // Uncomment and replace with your image widget
