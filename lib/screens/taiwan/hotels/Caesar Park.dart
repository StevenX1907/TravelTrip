...
class Caesar extends StatefulWidget {
  ...
  @override
  State<Caesar> createState() => _Caesar();
}

class _Caesar extends State<Caesar> {
          ...
          child: Padding(
            ...
            child: Column(
              ...
              children: <Widget>[
                Container(
                  ...
                  decoration: BoxDecoration(
                    ...
                    image: DecorationImage(
                      image: AssetImage(
                          'assets/taiwan/hotels/Caesar Park Taipei1.jpg'),
                      fit: BoxFit.cover,
                    ),
                  ),
                ...
                Text(
                  AppLocalizations.of(context).Caesar,
                  style: TextStyle(
                    fontSize: 24,
                ...
                Text(
                  AppLocalizations.of(context).CaesarDescription,
                      ...
                      child: GestureDetector(
                        onTap: () async {
                          await showDialog(
                            ...
                            builder: (_) => imageDialog(
                              'Caesar Park Taipei',
                              'assets/taiwan/destinations/Caesar Park Taipei2.jpg',
                              context,
                            ),
                          );
                        },
                        child: Container(
                          ...
                          decoration: BoxDecoration(
                            ...
                            borderRadius: BorderRadius.circular(12),
                            image: DecorationImage(
                              image: AssetImage('assets/taiwan/destinations/Caesar Park Taipei2.jpg'),
                              fit: BoxFit.cover,
                            ),
                          ),
                        ),
                      ...
                      child: GestureDetector(
                        onTap: () async {
                          await showDialog(
                            ...
                            builder: (_) => imageDialog(
                              'Caesar Park Taipei',
                              'assets/taiwan/destinations/Caesar Park Taipei3.jpg',
                              context,
                            ),
                          );
                        },
                      ...
                      child: GestureDetector(
                        onTap: () async {
                          await showDialog(
                            ...
                            builder: (_) => imageDialog(
                              'Caesar Park Taipei',
                              'assets/taiwan/destinations/Caesar Park Taipei4.jpg',
                              context,
                            ),
                          );
                        },
