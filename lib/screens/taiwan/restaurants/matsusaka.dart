...
class matsusaka extends StatefulWidget {
  const matsusaka({super.key});

  @override
  State<matsusaka> createState() => _matsusakaState();
}

class _matsusakaState extends State<matsusaka> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        title: Text(AppLocalizations.of(context).matsu),
          ...
          child: Padding(
            ...
            child: Column(
              ...
              children: <Widget>[
                Container(
                  ...
                  decoration: BoxDecoration(
                    ...
                    image: DecorationImage(
                      image: AssetImage(
                          'assets/taiwan/restaurants/matsu4.jpg'),
                      fit: BoxFit.cover,
                    ),
                  ),
                ...
                Text(
                  AppLocalizations.of(context).matsu,
                ...
                Text(
                  AppLocalizations.of(context).matsuDescription,
                      ...
                      child: GestureDetector(
                        ...
                        child: Container(
                          ...
                          decoration: BoxDecoration(
                            ...
                            image: DecorationImage(
                              image: AssetImage(
                                  'assets/taiwan/restaurants/matsu1.jpg'),
                              fit: BoxFit.cover,
                            ),
                          ),
                          // child: YourImageWidget(), // Uncomment and replace with your image widget
                      ...
                      child: GestureDetector(
                        ...
                        child: Container(
                          ...
                          decoration: BoxDecoration(
                            ...
                            image: DecorationImage(
                              image: AssetImage(
                                  'assets/taiwan/restaurants/matsu2.jpg'),
                              fit: BoxFit.cover,
                            ),
                          ),
                          // child: YourImageWidget(), // Uncomment and replace with your image widget
                      ...
                      child: GestureDetector(
                        ...
                        child: Container(
                          ...
                          decoration: BoxDecoration(
                            ...
                            image: DecorationImage(
                              image: AssetImage(
                                  'assets/taiwan/restaurants/matsu3.jpg'),
                              fit: BoxFit.cover,
                            ),
                          ),
                          // child: YourImageWidget(), // Uncomment and replace with your image widget
                ...
                ListTile(
                  ...
                  title: Text(AppLocalizations.of(context).matsuAddress),
                ),
                ListTile(
                  leading: Icon(Icons.phone),
                  title: Text(AppLocalizations.of(context).matsuContact),
                ),
                // Comment Section
                const SizedBox(height: 16),
                Text(
