...
class Taroko extends StatefulWidget {
  const Taroko({Key? key}) : super(key: key);

  @override
  State<Taroko> createState() => _Taroko();
}

class _Taroko extends State<Taroko> {
          ...
          child: Padding(
            ...
            child: Column(
              ...
              children: <Widget>[
                Container(
                  ...
                  decoration: BoxDecoration(
                    ...
                    image: DecorationImage(
                      image: AssetImage(
                          'assets/taiwan/destinations/Taroko Gorge1.jpg'),
                      fit: BoxFit.cover,
                    ),
                  ),
                ...
                Text(
                  AppLocalizations.of(context).Taroko,
                  style: TextStyle(
                    fontSize: 24,
                ...
                Text(
                  AppLocalizations.of(context).TarokoDescription,
                      ...
                      child: GestureDetector(
                        onTap: () async {
                          await showDialog(
                            ...
                            builder: (_) => imageDialog(
                              'Taroko Gorge',
                              'assets/taiwan/destinations/Taroko Gorge2.jpg',
                              context,
                            ),
                          );
                        },
                        child: Container(
                          ...
                          decoration: BoxDecoration(
                            ...
                            borderRadius: BorderRadius.circular(12),
                            image: DecorationImage(
                              image: AssetImage('assets/taiwan/destinations/Taroko Gorge2.jpg'),
                              fit: BoxFit.cover,
                            ),
                          ),
                        ),
                      ...
                      child: GestureDetector(
                        onTap: () async {
                          await showDialog(
                            ...
                            builder: (_) => imageDialog(
                              'Taroko Gorge',
                              'assets/taiwan/destinations/Taroko Gorge3.jpg',
                              context,
                            ),
                          );
                        },
                      ...
                      child: GestureDetector(
                        onTap: () async {
                          await showDialog(
                            ...
                            builder: (_) => imageDialog(
                              'Taroko Gorge',
                              'assets/taiwan/destinations/Taroko Gorge4.jpg',
                              context,
                            ),
                          );
                        },
