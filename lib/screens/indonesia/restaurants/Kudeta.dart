...
class kudeta extends StatefulWidget {
  ...
  @override
  State<kudeta> createState() => _kudeta();
}
                ...
                Container(
                  ...
                  decoration: BoxDecoration(
                    ...
                    image: DecorationImage(
                      image: AssetImage(
                          'assets/indonesia/restaurants/Kudeta 1.jpeg'),
                      fit: BoxFit.cover,
                    ),
                  ),
                        ...
                        onTap: () async {
                          await showDialog(
                            ...
                            builder: (_) => imageDialog(
                              'Enjoy sunset with dinner at Ku De Ta',
                              'assets/indonesia/restaurants/Kudeta 4.jpeg',
                              context,
                            ),
                          );
                        },
                        ...
                        onTap: () async {
                          await showDialog(
                            ...
                            builder: (_) => imageDialog(
                              ...
                              'assets/indonesia/restaurants/Kudeta 5.jpeg',
                              context,
                            ),
                          );
                        },
                      ...
                      child: GestureDetector(
                        onTap: () async {
                          await showDialog(
                            context: context,
                            builder: (_) => imageDialog(
                              'PLAYFUL. TROPICAL. PREMIUM.',
                              'assets/indonesia/restaurants/Kudeta 3.jpeg',
                              context,
                            ),
                          );
                        },
