...
class Kokiku extends StatefulWidget {
  const Kokiku({Key? key}) : super(key: key);

  @override
  State<Kokiku> createState() => _Kokiku();
}

class _Kokiku extends State<Kokiku> {
          ...
          child: Padding(
            ...
            child: Column(
              ...
              children: <Widget>[
                Container(
                  ...
                  decoration: BoxDecoration(
                    ...
                    image: DecorationImage(
                      image: AssetImage(
                          'assets/indonesia/restaurants/Feast by Kokiku1.jpg'),
                      fit: BoxFit.cover,
                    ),
                  ),
                ...
                Text(
                  AppLocalizations.of(context).Kokiku,
                  style: TextStyle(
                    fontSize: 24,
                ...
                Text(
                  AppLocalizations.of(context).KokikuDescription,
                      ...
                      child: GestureDetector(
                        onTap: () async {
                          await showDialog(
                            ...
                            builder: (_) => imageDialog(
                              'Feast by Kokiku',
                              'assets/indonesia/restaurants/Feast by Kokiku2.jpg',
                              context,
                            ),
                          );
                        },
                        child: Container(
                          ...
                          decoration: BoxDecoration(
                            ...
                            borderRadius: BorderRadius.circular(12),
                            image: DecorationImage(
                              image: AssetImage('assets/indonesia/restaurants/Feast by Kokiku2.jpg'),
                              fit: BoxFit.cover,
                            ),
                          ),
                        ),
                      ...
                      child: GestureDetector(
                        onTap: () async {
                          await showDialog(
                            ...
                            builder: (_) => imageDialog(
                              'Feast by Kokiku',
                              'assets/indonesia/restaurants/Feast by Kokiku3.jpg',
                              context,
                            ),
                          );
                        },
                      ...
                      child: GestureDetector(
                        onTap: () async {
                          await showDialog(
                            ...
                            builder: (_) => imageDialog(
                              'Feast by Kokiku',
                              'assets/indonesia/restaurants/Feast by Kokiku4.jpg',
                              context,
                            ),
                          );
                        },
