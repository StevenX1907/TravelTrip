...
class bandarDjakarta extends StatefulWidget {
  ...
  @override
  State<bandarDjakarta> createState() => _bandarDjakarta();
}
                ...
                Container(
                  ...
                  decoration: BoxDecoration(
                    ...
                    image: DecorationImage(
                      image: AssetImage(
                          'assets/indonesia/restaurants/Bandar 1.jpeg'),
                      fit: BoxFit.cover,
                    ),
                  ),
                        ...
                        onTap: () async {
                          await showDialog(
                            ...
                            builder: (_) => imageDialog(
                              'Smoked Crab with Tabanan Sauce',
                              'assets/indonesia/restaurants/Bandar 2.png',
                              context,
                            ),
                          );
                        },
                      ...
                      child: GestureDetector(
                        onTap: () async {
                          await showDialog(
                            context: context,
                            builder: (_) => imageDialog(
                              'Seafood Fried Rice Specialty',
                              'assets/indonesia/restaurants/Bandar 3.png',
                              context,
                            ),
                          );
                        },
                      ...
                      child: GestureDetector(
                        onTap: () async {
                          await showDialog(
                            context: context,
                            builder: (_) => imageDialog(
                              'Enjoy Fresh and Delicious Seafood Platter',
                              'assets/indonesia/restaurants/Bandar 4.jpeg',
                              context,
                            ),
                          );
                        },
