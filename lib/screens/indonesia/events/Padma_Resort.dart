...
class PadmaResort extends StatefulWidget {
  const PadmaResort({Key? key}) : super(key: key);

  @override
  State<PadmaResort> createState() => _PadmaResort();
}

class _PadmaResort extends State<PadmaResort> {
          ...
          child: Padding(
            ...
            child: Column(
              ...
              children: <Widget>[
                Container(
                  ...
                  decoration: BoxDecoration(
                    ...
                    image: DecorationImage(
                      image: AssetImage(
                          'assets/indonesia/hotels/PadmaResort1.jpg'),
                      fit: BoxFit.cover,
                    ),
                  ),
                ...
                Text(
                  AppLocalizations.of(context).PadmaResort,
                  style: TextStyle(
                    fontSize: 24,
                ...
                Text(
                  AppLocalizations.of(context).PadmaResortDescription,
                      ...
                      child: GestureDetector(
                        onTap: () async {
                          await showDialog(
                            ...
                            builder: (_) => imageDialog(
                              'Padma Resort',
                              'assets/indonesia/hotels/PadmaResort2.jpg',
                              context,
                            ),
                          );
                        },
                        child: Container(
                          ...
                          decoration: BoxDecoration(
                            ...
                            borderRadius: BorderRadius.circular(12),
                            image: DecorationImage(
                              image: AssetImage('assets/indonesia/hotels/PadmaResort2.jpg'),
                              fit: BoxFit.cover,
                            ),
                          ),
                        ),
                      ...
                      child: GestureDetector(
                        onTap: () async {
                          await showDialog(
                            ...
                            builder: (_) => imageDialog(
                              'Padma Resort',
                              'assets/indonesia/hotels/PadmaResort3.jpg',
                              context,
                            ),
                          );
                        },
                      ...
                      child: GestureDetector(
                        onTap: () async {
                          await showDialog(
                            ...
                            builder: (_) => imageDialog(
                              'Padma Resort',
                              'assets/indonesia/hotels/PadmaResort4.jpg',
                              context,
                            ),
                          );
                        },
