...
class Adiwana extends StatefulWidget {
  const Adiwana({Key? key}) : super(key: key);

  @override
  State<Adiwana> createState() => _Adiwana();
}

class _Adiwana extends State<Adiwana> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        title: Text('Adiwana Unagi Suites'),
          ...
          child: Padding(
            ...
            child: Column(
              ...
              children: <Widget>[
                Container(
                  ...
                  decoration: BoxDecoration(
                    ...
                    image: DecorationImage(
                      image: AssetImage(
                          'assets/indonesia/destinations/Adiwana Unagi Suites1.jpeg'),
                      fit: BoxFit.cover,
                    ),
                  ),
                ...
                Text(
                  AppLocalizations.of(context).AdiwanaUnagiSuites,
                  style: TextStyle(
                    fontSize: 24,
                ...
                Text(
                  AppLocalizations.of(context).AdiwanaUnagiSuitesDescription,
                      ...
                      child: GestureDetector(
                        onTap: () async {
                          await showDialog(
                            ...
                            builder: (_) => imageDialog(
                              ...
                              'assets/indonesia/destinations/Adiwana Unagi Suites2.jpeg',
                              context,
                            ),
                          );
                        },
                        child: Container(
                          ...
                          decoration: BoxDecoration(
                            ...
                            borderRadius: BorderRadius.circular(12),
                            image: DecorationImage(
                              image: AssetImage('assets/indonesia/destinations/Adiwana Unagi Suites2.jpeg'),
                              fit: BoxFit.cover,
                            ),
                          ),
                        ),
                      ...
                      child: GestureDetector(
                        onTap: () async {
                          await showDialog(
                            ...
                            builder: (_) => imageDialog(
                              'Adiwana Unagi Suites',
                              'assets/indonesia/destinations/Adiwana Unagi Suites3.jpeg',
                              context,
                            ),
                          );
                        },
                      ...
                      child: GestureDetector(
                        onTap: () async {
                          await showDialog(
                            ...
                            builder: (_) => imageDialog(
                              'Adiwana Unagi Suites',
                              'assets/indonesia/destinations/Adiwana Unagi Suites4.jpeg',
                              context,
                            ),
                          );
                        },
