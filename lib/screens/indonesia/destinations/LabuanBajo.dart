...
class LabuanBajo extends StatefulWidget {
  const LabuanBajo({Key? key}) : super(key: key);

  @override
  State<LabuanBajo> createState() => _LabuanBajo();
}

class _LabuanBajo extends State<LabuanBajo> {
          ...
          child: Padding(
            ...
            child: Column(
              ...
              children: <Widget>[
                Container(
                  ...
                  decoration: BoxDecoration(
                    ...
                    image: DecorationImage(
                      image: AssetImage(
                          'assets/indonesia/destinations/Labuan Bajo1.jpg'),
                      fit: BoxFit.cover,
                    ),
                  ),
                ...
                Text(
                  AppLocalizations.of(context).LabuanBajo,
                  style: TextStyle(
                    fontSize: 24,
                ...
                Text(
                  AppLocalizations.of(context).LabuanBajoDescription,
                      ...
                      child: GestureDetector(
                        onTap: () async {
                          await showDialog(
                            ...
                            builder: (_) => imageDialog(
                              'LabuanBajo',
                              'assets/indonesia/destinations/Labuan Bajo2.jpg',
                              context,
                            ),
                          );
                        },
                        child: Container(
                          ...
                          decoration: BoxDecoration(
                            ...
                            borderRadius: BorderRadius.circular(12),
                            image: DecorationImage(
                              image: AssetImage('assets/indonesia/destinations/Labuan Bajo2.jpg'),
                              fit: BoxFit.cover,
                            ),
                          ),
                        ),
                      ...
                      child: GestureDetector(
                        onTap: () async {
                          await showDialog(
                            ...
                            builder: (_) => imageDialog(
                              'Labuan Bajo',
                              'assets/indonesia/destinations/Labuan Bajo3.jpg',
                              context,
                            ),
                          );
                        },
                      ...
                      child: GestureDetector(
                        onTap: () async {
                          await showDialog(
                            ...
                            builder: (_) => imageDialog(
                              'Labuan Bajo',
                              'assets/indonesia/destinations/Labuan Bajo4.jpg',
                              context,
                            ),
                          );
                        },
