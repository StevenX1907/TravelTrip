...
class Phong extends StatefulWidget {
  const Phong({Key? key}) : super(key: key);

  @override
  State<Phong> createState() => _Phong();
}

class _Phong extends State<Phong> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        title: Text('Phong Nha-Ke Bang National Park'),
          ...
          child: Padding(
            ...
            child: Column(
              ...
              children: <Widget>[
                Container(
                  ...
                  decoration: BoxDecoration(
                    ...
                    image: DecorationImage(
                      image: AssetImage(
                          'assets/vietnam/destinations/Phong Nha-Ke Bang National Park1.jpg'),
                      fit: BoxFit.cover,
                    ),
                  ),
                ...
                Text(
                  AppLocalizations.of(context).Phong,
                  style: TextStyle(
                    fontSize: 24,
                ...
                Text(
                  AppLocalizations.of(context).PhongDescription,
                      ...
                      child: GestureDetector(
                        onTap: () async {
                          await showDialog(
                            ...
                            builder: (_) => imageDialog(
                              ...
                              'assets/vietnam/destinations/Phong Nha-Ke Bang National Park2.jpg',
                              context,
                            ),
                          );
                        },
                        child: Container(
                          ...
                          decoration: BoxDecoration(
                            ...
                            borderRadius: BorderRadius.circular(12),
                            image: DecorationImage(
                              image: AssetImage('assets/vietnam/destinations/Phong Nha-Ke Bang National Park2.jpg'),
                              fit: BoxFit.cover,
                            ),
                          ),
                        ),
                      ...
                      child: GestureDetector(
                        onTap: () async {
                          await showDialog(
                            ...
                            builder: (_) => imageDialog(
                              'Phong Nha-Ke Bang National Park',
                              'assets/vietnam/destinations/Phong Nha-Ke Bang National Park3.jpg',
                              context,
                            ),
                          );
                        },
                      ...
                      child: GestureDetector(
                        onTap: () async {
                          await showDialog(
                            ...
                            builder: (_) => imageDialog(
                              'Hue',
                              'assets/vietnam/destinations/Phong Nha-Ke Bang National Park4.jpg',
                              context,
                            ),
                          );
                        },
